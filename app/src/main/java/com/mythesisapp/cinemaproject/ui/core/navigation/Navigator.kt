...
import com.mythesisapp.cinemaproject.presentation.Authenticator
...
import com.mythesisapp.cinemaproject.ui.core.PermissionManager
import com.mythesisapp.cinemaproject.ui.home.HomeActivity
import com.mythesisapp.cinemaproject.ui.home.MessagesActivity
import com.mythesisapp.cinemaproject.ui.login.LoginActivity
import com.mythesisapp.cinemaproject.ui.register.RegisterActivity
import com.mythesisapp.cinemaproject.ui.login.ForgetPasswordActivity
...
@Inject constructor(
    ...
    fun showUser(context: Context, friendEntity: FriendEntity) {
        ...
        bundle.putString(ApiService.PARAM_SURNAME, friendEntity.surname)
        bundle.putString(ApiService.PARAM_BIRTHDAY, friendEntity.birthday)
        bundle.putString(ApiService.PARAM_CITY, friendEntity.city)
