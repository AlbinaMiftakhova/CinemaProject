package com.mythesisapp.cinemaproject.ui.firebase
...
import com.mythesisapp.cinemaproject.domain.messages.ContactEntity
import com.mythesisapp.cinemaproject.domain.messages.GetMessagesWithContact
...
class NotificationHelper @Inject constructor(
    ...
    private fun parseFriend(jsonMessage: JSONObject): FriendEntity {
        ...
        val image = requestUser.getString(ApiService.PARAM_IMAGE)
        val surname = requestUser.getString(ApiService.PARAM_SURNAME)
        val city = requestUser.getString(ApiService.PARAM_CITY)
        val birthday = requestUser.getString(ApiService.PARAM_BIRTHDAY)

        return FriendEntity(id, name, email, friendsId, surname, birthday, city, image)
    }
